...
public class ChatController {
    ...
    public String intro(HttpServletRequest request, HttpSession session)
        ...
        log.info(this.getClass().getName() + ".intro 시작");
        ...
        log.info(this.getClass().getName() + ".intro 끝");
    ...
    public Set<String> roomList() throws Exception{
        log.info(this.getClass().getName() + ".roomList 시작");
        ...
        log.info(this.getClass().getName() + ".roomList 끝");
    ...
    public List<ChatDTO> msg(HttpServletRequest request, HttpSession session)
        ...
        log.info(this.getClass().getName() + ".msg 시작");
        ...
        log.info(this.getClass().getName() + ".msg 끝");
    ...
    public List<ChatDTO> getMsg(HttpSession session)  throws Exception{
        ...
        log.info(this.getClass().getName() + ".getMsg 시작");

        String room_name = CmmUtil.nvl((String) session.getAttribute("SS_ROOM_NAME"));

        log.info("room_naem : " + room_name);
        ...
        log.info(this.getClass().getName() + ".getMsg 끝");
